...
namespace JinRohArmor
{
	...
	public class PatchOperationModVersion : PatchOperation
	{
		...
		protected override bool ApplyWorker(XmlDocument xml)
		{
			...
			if (flag5)
			{
				Log.Message("[JinRoh Armor] PatchOperationModVersion passed: Loading selected patch", false);
		...
		{
			int versionNumber = LoadedModManager.GetMod<JinRohSettings.JinRohMod>().GetSettings<JinRohSettings>().versionNumber;
